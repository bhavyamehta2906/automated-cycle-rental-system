...
s: while (!mySerial.available()) {
    ...
    if (client.connect(server, 80)) {
      ...
      String sendData = writeAPIKey + "&field1=" + String(a) + "&field2=" + String(b);
    ...
    String rfidd = ThingSpeak.readStringField (channelID, 3, myreadAPIKey);
    ...
    String rfiddd = ThingSpeak.readStringField (channelID, 4, myreadAPIKey);
    if (statusCode == 200) {
      Serial.println("The slot 2 rfid number is : " + String(rfiddd));
  ...
  if (mySerial.available())
  {
    ...
    if (flag1 == 1)
    {
      ...
      if (client.connect(server, 80)) {
        ...
        String sendData = writeAPIKey + "&field3=0000000000000";
...
//         Serial.println(b);
    ...
    else  if (flag2 == 1)
    {
      ...
      if (client.connect(server, 80)) {
        ...
        String sendData = writeAPIKey + "&field4=0000000000000";
