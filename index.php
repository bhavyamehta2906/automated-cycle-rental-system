...
if(isset($_POST['login']))
{
	...
	$sql="select `password` from bhavya where `username`='$username'";
	...
	{ 
	$abc="select `RFID_NO` from bhavya where `username`='$username'";
	$qwerty="select `Balance` from bhavya where `username`='$username'";
	$asdf="select `Station_No` from bhavya where `username`='$username'";
	$xyz="select `Slot_No` from bhavya where `username`='$username'";
	$mno="select `status` from bhavya where `username`='$username'";
...
<body>
	...
	<ul>
		...
		<div class="bottum" id="btm" style="position:absolute;
			...
			<font color:"white">	<i>AUTOMATED ROVER SERVICE</b>    |    All rights reserved@ BHAVYA MEHTA</i></font>
			</div>
